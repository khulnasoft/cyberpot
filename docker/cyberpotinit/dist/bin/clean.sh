...
chown cyberpot:cyberpot $myADBHONEYTGZ $myCOWRIETTYTGZ $myCOWRIEDLTGZ $myDIONAEABITGZ $myDIONAEABINTGZ $myH0NEYTR4PTGZ $myHONEYTRAPATTACKSTGZ $myHONEYTRAPDLTGZ $myMINIPRINTTGZ $myTANNERFTGZ
...
chown cyberpot:cyberpot $myADBHONEYDL $myCOWRIETTYLOGS $myCOWRIEDL $myDIONAEABI $myDIONAEABIN $myH0NEYTR4PP $myHONEYTRAPATTACKS $myHONEYTRAPDL $myMINIPRINTU $myTANNERF
...
fuBEELZEBUB () {
  ...
  chown cyberpot:cyberpot /data/beelzebub/ -R
}
...
fuGALAH () {
  ...
  chown cyberpot:cyberpot /data/galah/ -R
}
...
fuGOPOT () {
  ...
  chown cyberpot:cyberpot /data/go-pot -R
}
...
fuH0NEYTR4P () {
  ...
  chown cyberpot:cyberpot /data/h0neytr4p/ -R
}
...
fuHONEYAML () {
  ...
  chown cyberpot:cyberpot -R /data/honeyaml
}
...
fuMINIPRINT () {
  ...
  chown cyberpot:cyberpot /data/miniprint/ -R
}
